  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>宠物</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.petId" placeholder="宠物ID" @keyup.enter.native="handleSearch"></el-input>
          </el-form-item>

          <el-form-item>
            <el-input v-model="filters.openid" placeholder="用户ID" @keyup.enter.native="handleSearch"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="dataList" highlight-current-row @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop="petId" label="宠物ID"></el-table-column>
        <el-table-column prop="openid" label="宠物主人"></el-table-column>
        <el-table-column prop=petName" label="宠物名"></el-table-column>
        <el-table-column prop="petType" label="宠物类型"></el-table-column>
        <el-table-column prop="petBreed" label="宠物品种"></el-table-column>
        <el-table-column prop="petSex" label="宠物性别" width="60"></el-table-column>
        <el-table-column prop="isBind" label="是否绑定" width="60" ></el-table-column>
