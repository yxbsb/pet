<template>
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <addDevice :call="search" icon="el-icon-plus" type="primary" title="新增"/>
      <!--列表-->
      <el-table :data="dataList" highlight-current-row @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <AddDevice :call="search" :data="scope.row" size="mini" title="编辑"/>
...
<script>
import AddDevice from "./AddDevcie";
import api from '../../api/api_device';
import {pass} from "../../../test/e2e/custom-assertions/elementCount";
